...
SET GLOBAL SQL_MODE = "STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION";  # fix GROUP BY时，报"ONLY_FULL_GROUP_BY"错误，（该模式下，SELECT中的列，必须都存在于GROUP BY中）
